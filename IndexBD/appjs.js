...
//Aqui indicamos todos los navegadores para que funcione la base datos con ello.
if (!window.indexedDB) {
    alert();
}

let request = window.indexedDB.open("QuizQuestDatabase", 2),  // nombre y version de base de datos (abrimos la BD)
    db,
    tx,
    store,
    index;
